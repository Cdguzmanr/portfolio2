...
const ProjectCard: React.FC<Project> = ({ title, image, category, summary, description, video, link }) => {
  ...
  return (
    <>
      {/* Card View */}
      <div onClick={openModal} className="group max-w-sm p-6 my-6 md:mx-3 bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-blue-300">
